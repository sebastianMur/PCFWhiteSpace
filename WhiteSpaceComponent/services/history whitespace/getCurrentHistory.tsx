const queryfetchXml = (context: any) => {
  let fetchXml = `<fetch version="1.0" output-format="xml-platform" mapping="logical" distinct="false"><entity name="swo_historywhitespaceap">
      ...
      <condition attribute="swo_whitespaceid" operator="eq" uiname="Account Test undefined" uitype="swo_whitespace" value="${context.parameters.Data.sortedRecordIds[0]}" />
    </filter>
  </entity>
</fetch>`;
...
export const GetCurrentHistoryWhitespace = (context: any) => {
